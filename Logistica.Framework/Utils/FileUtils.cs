...
namespace Logistica.Framework
{
    public sealed class FileUtils
    {
        ...
        public static string[] List(string path, string searchPattern, bool includeSubFolders)
        {
            string[] array;
            if (FolderUtils.Exist(path))
            {
                string[] textArray1 = searchPattern.Split(new char[] { ';' });
                ArrayList list1 = new ArrayList();
                for (int num1 = 0; num1 < (int)textArray1.Length; num1++)
                {
                    string[] textArray2 = Directory.GetFiles(path, textArray1[num1].ToString());
                    list1.AddRange(textArray2);
                }
                array = (string[])list1.ToArray(typeof(string));
            }
            else
            {
                array = null;
        ...
        {
            //string sourcePath = @"C:\JC\S10\Web\LogicArt.Erp.Plantillas.Web\Plantillas\";
            //string targetPath = @"C:\JC\S10\Web\LogicArt.Erp.Pedidos.Web\Plantillas\";

            //var extensions = new string[] { ".Master" }; // not sure if you really wanted to filter by extension or not, it kinda seemed like maybe you did. if not, comment this out
        ...
        //public static bool Exists(string filename,bool subfolder = false)
        //{
        //    if (!subfolder)
        //    {
        ...
        //        {
        //            return Exists( Path.Combine(subDir, filename),true);
        //        }

        //        //var file = Directory.GetFiles(filename, "*.*", SearchOption.AllDirectories)
        //        //        .FirstOrDefault();
        //        //if (file == null)
        //        //{
        //        //    return false;
        ...
        public static bool MoverImagen(string rutaOrigen, string carpetaFinal, string nuevoNombre, string extension)
        {
        ...
        public static bool MoverImagen(string rutaOrigen, string rutaFinal)
        {
            bool estado = false;
            do
            {
        ...
        public static string[] SepararCadenas(string nombreFile)
        {
        ...
        public static string[] SepararCadenas(string cadena, string limitador)
        {
            string cadenadelimitador = limitador;
            char[] delimitador = cadenadelimitador.ToCharArray();
            string[] split = null;

            split = cadena.Split(delimitador);

            return split;
        }


        public static bool ComprobarEstado(string file)
        {
        ...
        public static string CambiarNombreFile(string filename, string newname)
        {
        ...
        /// <returns></returns>
        public static string[] BuscarArchivos(string path, string searchPattern, bool includeSubFolders)
        {
        ...
        public static ArrayList BuscarServerArchivos(string path, string searchPattern, bool includeSubFolders)
        {
