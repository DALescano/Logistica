    ...
    _privateFunction: {
        CreateGrid: function (dataSource) {
            ...
            this.core = this.table.DataTable({
                etiquetaGrillaSinInformacion: Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaGrillaTablaSinRegistro,
                etiquetaGrillaBotonAnterior: Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaGrillaBotonAnterior,
                etiquetaGrillaBotonSiguiente: Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaGrillaBotonSiguiente,
                etiquetaGrillaMostrarFilas: Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaGrillaMostrarFilas,
...
Pe.GMD.UI.Web.Components.GridAction = {
    Check: {
        ...
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('check', 'fa-check-square fa-check-square-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridAprobar);
        //}
        Source: function (id, tooltip, index) {            
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridAprobar;
    ...
    Consulta: {
        ...
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('consulta', 'fa-question-circle fa-question-circle-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridConsulta);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridConsulta;
    ...
    Observacion: {
        ...
        Icon: 'fa-eye',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('eyes', 'fa-eye fa-eye-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridObservacion);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridObservacion;
    ...
    Pdf: {
        ...
        Icon: 'fa-file-pdf-o',
        //Source: function (id, tooltip) {
        //    return Pe.GMD.UI.Web.Components.GridAction.Source(id, Pe.GMD.UI.Web.Components.GridAction.Pdf, (tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridContrato));
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridContrato;
    ...
    Adjunto: {
        ...
        Icon: 'fa-paperclip',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('paperclip', 'fa-paperclip fa-paperclip-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridAdjunto);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridAdjunto;
    ...
    VistaPrevia: {
        ...
        Icon: 'fa-picture-o',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('vistaPrevia', 'fa-file-pdf-o fa-file-pdf-o-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridVistaPrevia);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridVistaPrevia;
    ...
    Parrafo: {
        ...
        Icon: 'fa-tasks',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('parrafo', 'fa-tasks fa-tasks-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridParrafo);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridParrafo;
    ...
    Variable: {
        ...
        Icon: 'fa-sign-in',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('variable', 'fa-sign-in fa-sign-in-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridAgregarVariable);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridAgregarVariable;
    ...
    Estadios: {
        ...
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('estadios', 'fa-external-link fa-external-link-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridEstadios);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridEstadios;
    ...
    Temas: {
        ...
        Icon: 'fa-tasks',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('temas', 'fa-tasks fa-tasks-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridTemas);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridSeleccionarProcesos;
    ...
    Predecesora: {
        ...
        Icon: 'fa-tasks',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('predecesora', 'fa-tasks fa-tasks-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridPredecesora);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridPredecesora;
    ...
    Evidencia: {
        ...
        Icon: 'fa-external-link',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('evidencia', 'fa-external-link fa-external-link-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridEvidencia);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridEvidencia;
    ...
    Edit: {
        ...
        Icon: 'fa-edit',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('edit', 'fa-edit fa-edit-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaEditar);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridEditar;
    ...
    EditText: {
        ...
        Icon: 'fa-text-width',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('edit', 'fa-text-width fa-text-width-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaEditarContenidoContrato);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaEditarContenidoContrato;
    ...
    Delete: {
        ...
        Icon: 'fa-trash',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('delete', 'fa-trash fa-trash-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaEliminar);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridEliminar;
    ...
    Copy: {
        ...
        Icon: 'fa-copy',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('copiar', 'fa-copy fa-copy-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaCopiar);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaCopiar;
    ...
    CopyEstadios: {
        ...
        Icon: 'fa-copy',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('copiarEstadio', 'fa-copy fa-copy-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaCopiarEstadio);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaCopiarEstadio;
    ...
    CopyPlantilla: {
        ...
        Icon: 'fa-copy',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('copiarPlantilla', 'fa-copy fa-copy-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaCopiarPlantilla);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaCopiarPlantilla;
    ...
    Close: {
        ...
        Icon: 'fa-lock',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('cerrar', 'fa-lock fa-lock-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaBloquear);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaBloquear;
    ...
    Open: {
        ...
        Icon: 'fa-unlock',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('abrir', 'fa-unlock fa-unlock-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaDesbloquear);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaDesbloquear;
    ...
    Notify: {
        ...
        Icon: 'fa-envelope-o',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('notificar', 'fa-envelope-o fa-envelope-o-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaNotificar);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaNotificar;
    ...
    Play: {
        ...
        Icon: 'fa-play',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('iniciar', 'fa-play fa-play-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaIniciar);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaIniciar;
    ...
    FechaActividad: {
        ...
        Icon: 'fa-calendar',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('fechaActividad', 'fa-calendar fa-calendar-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaFechaActividad);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaFechaActividad;
    ...
    Responsables: {
        ...
        Icon: 'fa-tasks',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('responsable', 'fa-tasks fa-tasks-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaResponsables);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaResponsables;
    ...
    ResponsableEvidencia: {
        ...
        Icon: 'fa-external-link',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('responsableEvidencia', 'fa-external-link fa-external-link-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaResponsableEvidencias);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaResponsableEvidencias;
    ...
    FileUpload: {
        ...
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('verificar', 'fa-upload ' + selector, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaGridFileUpload);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaGridFileUpload;
    ...
    VerEquipos: {
        Icon: 'fa-truck',
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridSeleccionarEquipos;
    ...
    ReporteRecord: {
        ...
        Icon: 'fa-file-pdf-o',
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridReporteRecord;
    ...
    Revisar: {
        ...
        Icon: 'fa-eye',
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridRevisar;
    ...
    VerAccion: {
        ...
        Icon: 'fa-eye',
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridVerAccion;
    ...
    VerHistorialInvestigacion: {
        ...
        Icon: 'fa-eye',
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridVerHistorialInvestigacion;
    ...
    RegistroSeguimiento: {
        ...
        Icon: 'fa-list',
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridRegistroSeguimiento;
    ...
    VerSeguimiento: {
        ...
        Icon: 'fa-tasks',
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridVerSeguimiento;
    ...
    DescargarFoto: {
        ...
        Icon: 'fa-image',
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridDescargarFoto;
    ...
    DescargarAnexo: {
        ...
        Icon: 'fa-download',
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridDescargarAnexo;
    ...
    ValorAlquiler: {
        ...
        Icon: 'fa-tasks',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('valorAlquiler', 'fa-tasks fa-tasks-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridValorAlquiler);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridValorAlquiler;
    ...
    DescargarAdjunto: {
        ...
        Icon: 'fa-download',
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridDescargar;
    ...
    DescargarIncidente: {
        ...
        Icon: 'fa-file-pdf-o',
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridDescargarIncidente;
    ...
    DescargarInvestigacion: {
        ...
        Icon: 'fa-file-pdf-o',
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridDescargarInvestigacion;
    ...
    AsignarSuplente: {
        ...
        Icon: 'fa-user',
        //Source: function (id, tooltip) {
        //    tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaAsignarSuplente;
        //    return Pe.GMD.UI.Web.Components.GridAction.Source(id, Pe.GMD.UI.Web.Components.GridAction.AsignarSuplente, tooltip);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridSeleccionarPersonas;
    ...
    RegistrarNotas: {
        ...
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridRegistrarNotas;
    ...
    ResponderConsulta: {
        ...
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('responder', 'fa-paper-plane-o fa fa-paper-plane-o-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaResponder);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaResponder;
    ...
    Reenviar: {
        ...
        Icon: 'fa-share',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('reenviar', 'fa-share fa fa-share-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaReenviar);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaReenviar;
    ...
    Visualizar: {
        ...
        Icon: 'fa-eye',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('eyes', 'fa-eye fa-eye-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaVisualizar);
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaVisualizar;
    ...
    VerFirma: {
        ...
        Icon: 'fa-eye',
        //Source: function (id, tooltip) {
        //    tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaVerFirma;
    ...
    AsignarProyecto: {
        ...
        Icon: 'fa-link',
        Source: function (id, tooltip) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaAsignarProyecto;
    ...
    AsignarStaff: {
        ...
        Icon: 'fa-ellipsis-v',
        Source: function (id, tooltip) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaAsignarStaff;
