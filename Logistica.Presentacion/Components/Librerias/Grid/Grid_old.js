...
Pe.GMD.UI.Web.Components.Grid.prototype = {
    ...
    Init: function (opts) {
        ...
        this.scrollY = opts.scrollY != null ? opts.scrollY : "";
        if (opts.scrollX != undefined) {
            this.scrollX = opts.scrollX != null ? opts.scrollX : "100%";
        }
    ...
    _privateFunction: {
        ...
        CreateGridAsync: function (dataSource) {
            ...
            if (this.returnCallbackComplete != null) {
                this.returnCallbackComplete(records);
            }
        },
                ...
                var ajaxBuscarPaginadoServer = new Pe.GMD.UI.Web.Components.Ajax({
                    ...
                    onSuccess: function (data) {
                        ...
                        if (instancia.returnCallbackComplete != null) {
                            instancia.returnCallbackComplete(records);
                        }
                    }
                });
            }
        ...
        CallProxyWithoutPaginServer: function () {
            ...
            var ajaxBuscar = new Pe.GMD.UI.Web.Components.Ajax({
                ...
                onSuccess: function (data) {
                    ...
                    if (instancia.returnCallbackComplete != null) {
                        instancia.returnCallbackComplete(data[me.proxy.source]);
                    }
                }
            });
        }
...
Pe.GMD.UI.Web.Components.GridAction = {
    ...
    Temas: {
        ...
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridTemas;
    ...
    Edit: {
        ...
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaEditar;
    ...
    Delete: {
        ...
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.EtiquetaEliminar;
    ...
    DescargarAdjunto: {
        ...
        Icon: 'fa-download',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('descargar', 'fa-download fa-download-' + id, Pe.Stracon.SGSA.Presentacion.Base.GenericoResource.GridDescargar);
        //}
        Source: function (id, tooltip, index) {
